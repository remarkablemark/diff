    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex max-h-64 overflow-hidden rounded-md border border-gray-300 dark:border-gray-600">
        ...
        <textarea
          ...
          className="flex-1 resize-none overflow-x-auto overflow-y-auto bg-white px-3 py-2 font-mono text-sm leading-6 whitespace-pre text-gray-900 outline-none dark:bg-gray-800 dark:text-gray-100"
          spellCheck={false}
        />
      </div>
    </div>
